...
class AgregarAlergiaActivity : AppCompatActivity() {

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_agregar_alergia)
    ...
    private fun agregarAlergia(noMatricula: String, ingredienteId: String, observaciones: String) {
        val urlGlobal = getString(R.string.url)
        val url = "$urlGlobal/insertar_alergia.php"
